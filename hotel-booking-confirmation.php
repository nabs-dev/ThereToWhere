...
$stmt = $pdo->prepare("SELECT b.*, h.name, h.description, h.location, u.email FROM bookings b JOIN hotels h ON b.hotel_id = h.id JOIN users u ON b.user_id = u.id WHERE b.id = ? AND b.user_id = ?");
...
<head>
    ...
    <title>Hotel Booking Confirmation - ThereToWhere</title>
    <style>
        body {
