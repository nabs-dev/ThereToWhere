...
$booking_id = $_GET['id'];
$stmt = $pdo->prepare("SELECT b.*, p.title, p.description FROM bookings b JOIN packages p ON b.package_id = p.id WHERE b.id = ? AND b.user_id = ?");
...
<head>
    ...
    <title>Booking Details - ThereToWhere</title>
    <style>
        body {
...
<body>
    ...
    <div class="booking-details">
        ...
        <button onclick="window.location.href='booking-confirmation.php?id=<?php echo $booking['id']; ?>'">View Confirmation</button>
    </div>
</body>
</html>
